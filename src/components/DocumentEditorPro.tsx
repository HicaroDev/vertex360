...
export default function DocumentEditorPro({
    documentId,
    clientId,
    workspaceId,
    initialContent,
    ...
    const editor = useEditor({
        ...
        content: initialContent || '<p>Novo Documento</p>',
        editorProps: {
            ...
            handleClick: (view, pos, event) => {
                ...
                if (target instanceof HTMLElement && target.closest('summary')) {
                    ...
                    // Procura o nó pai que seja do tipo 'details'
    ...
    return (
        <div className="bg-white border-l border-r border-b border-brand-slate/10 relative">
            ...
            />
            <div className="editor-toolbar sticky top-[-48px] z-50 flex items-center justify-between bg-white border-b border-brand-slate/10 px-4 py-2 flex-wrap gap-2">
                <div className="flex items-center gap-1 flex-wrap">
                        ...
                        {showSpacingMenu && (
                            <div className="absolute top-full left-0 mt-2 bg-white border border-brand-slate/10 shadow-xl rounded-lg z-[100] w-40 p-1 animate-in fade-in slide-in-from-top-1">
                                ...
                                {[
                                    ...
                                    }} className="w-full text-left px-2 py-1.5 text-[10px] font-bold hover:bg-brand-cream hover:text-brand-gold rounded transition-colors whitespace-nowrap">
                                        {s.label}
                                    </button>
                                ))}
                            </div>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        {editor.isActive('table') && (
                            <div className="flex items-center gap-0.5 bg-amber-50 border border-amber-200 rounded p-0.5 animate-in slide-in-from-left-2 transition-all">
                ...
                <div className="flex items-center gap-4 pr-2">
                    <div className="text-[9px] font-black uppercase tracking-wider text-slate-400">
                        {saveStatus === 'saved' ? 'Sincronizado' : 'Sincronizando...'}
                    </div>
                </div>
            </div>
